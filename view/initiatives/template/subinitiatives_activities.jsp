 <script id="activities-template" type="x-tmpl-mustache">
<div class="card">
	<div class="header d-flex flex-row">
		<h5 class="prob d-flex flex-fill">
			<strong class="editableTxt1"
				onkeypress="return (this.innerText.length <= 25)" data-oldactivitiesHeader="{{activitiesHeader}}" id="activitiesHeader" editable="true">{{activitiesHeader}}</strong>
		</h5>
		<div class="create_initives add-sub-initiative">
			<span class="sub_initiative" data-toggle="modal"
				data-target=".sub_activities_popup"
				onclick="handleActivitiesEvent('{{initiativeId}}','', 'add')"><i
		...
		<ul class="header-dropdown m-r--2 d-flex">
			<li class="dropdown m-t--10"><a href="#" onclick="return false;"
				...
				<ul class="dropdown-menu pull-right" x-placement="bottom-start"
					...
					<li><a href="#" data-toggle="modal" data-target=".sub_activitie_view_popup" onclick="activitiesviewdetails({{initiativeId}},'initiative');">View</a></li>
