...
<link href="${contextroot}/css/bootstrap-popover-x.css" media="all" rel="stylesheet" />
...
.riskSidebarHighLight {
	...
	<body class="light">
                ...
                <img src="images/risk.png" alt="risk-summary" style="width: 20px;"/>
						...
						<div class="dropdown">
							<a href="#" role="button" id="dropdownMenuLink"
								...
								aria-expanded="false"> <i class="fas fa-filter"
							...
							<c:forEach items="${riskList}" var="risk">
								<c:choose>
									<c:when test="${risk.riskValue.riskStatus == 'Rare'}">
										<div class="d-flex flex-column sub_initiative_sidebar_details initiative_side_border_green sidebarriskid_${risk.id}" onclick="populateRiskDetails(${risk.impactId},${risk.id})">
									</c:when>
									<c:when test="${risk.riskValue.riskStatus == 'Unlikely'}">
										<div class="d-flex flex-column sub_initiative_sidebar_details initiative_side_border_yellow sidebarriskid_${risk.id}"	onclick="populateRiskDetails(${risk.impactId},${risk.id})">
									</c:when>
									<c:when test="${risk.riskValue.riskStatus == 'Possible' || risk.riskValue.riskStatus == 'Likely' || risk.riskValue.riskStatus == 'Almost Certain'}">
										<div class="d-flex flex-column sub_initiative_sidebar_details initiative_side_border_orange sidebarriskid_${risk.id}"	onclick="populateRiskDetails(${risk.impactId},${risk.id})">
									</c:when>
									<c:otherwise>
										<div class="d-flex flex-column sub_initiative_sidebar_details initiative_side_border_default sidebarriskid_${risk.id}" onclick="populateRiskDetails(${risk.impactId},${risk.id})">
									</c:otherwise>
								</c:choose>
												...
												<ul class="header-dropdown">
													<li class="dropdown title_edit_icon"><a href="#"
														...
														<ul class="dropdown-menu pull-right"
															...
															<li><a onclick="deleteRiskDetail(${kpiId}, ${riskDetail.id})">Delete</a>
															</li>
														</ul></li>
												</ul>
											</div>
												...
												<div class="">
													<ul class="list-unstyled order-list d-flex">
														<li class="avatar avatar-sm">
															<c:if test="${not empty riskDetail.riskValue.riskImage}">
																<img src="${riskDetail.riskValue.riskImage}"	class="rounded-circle" alt="User" width="50">
															</c:if> 
															<c:if test="${empty riskDetail.riskValue.riskImage}">
																<img data-name="${riskDetail.riskValue.name}"	class="rounded-circle riskuser" alt="User" width="50">
															</c:if>
														</li>
														<!-- <li class="avatar avatar-sm">
												...
												<div class="panel-heading risk-panel-heading" role="tab"
													...
													<div class="panel-title_risk">
														...
														<div
															...
															<a role="button" data-toggle="collapse" data-parent="#risk_accordion_1" href="#risk_treatment_1" aria-expanded="false" aria-controls="risk_treatment_1" class="collapsed" style="padding: 0px 0px !important;">
															</a>
																		...
																		<ul class="header-dropdown m-r--2 pt-3 d-flex"
																			...
																			<li class="dropdown"><a href="#"
																				...
																				<ul class="dropdown-menu pull-right"
																					...
																					<li><a
																						onclick="deleteRiskPlan(${riskPlan.id})">Delete</a></li>
																				</ul></li>
																		</ul>
																	</div>
																</div>
													...
													<div class="flex-column comment_image">
														...
														<c:if
															...
															<img
																...
																class="rounded-circle commentsuser" alt="User"
																width="40">
														</c:if>
													</div>
		...
		<script src="${contextroot}/js/bootstrap-popover-x.js" type="text/javascript"></script>
		<script src="${contextroot}/js/amcharts.js"></script>
		<script src="${contextroot}/js/serial.js"></script>
		<script src="${contextroot}/js/light.js"></script>
		<script src="${contextroot}/js/d3.v4.js"></script>
		<script src="${contextroot}/js/d3-scale-chromatic.v1.min.js"></script>
