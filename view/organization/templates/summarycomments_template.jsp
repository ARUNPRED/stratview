						...
						<ul class="header-dropdown m-r--2 pt-2 d-flex">
							<li class="dropdown"><a href="#" onclick="return false;"
								...
								<ul class="dropdown-menu pull-right" x-placement="bottom-start"
									...
									<li>
                                    	<a href="#" data-toggle="modal" data-target="#comment_edit_popup" onclick="handlesummaryCommentsPopup({{id}},'edit')">Edit</a>
                                    </li>
									<li><a onclick="deleteRisksummary({{id}})">Delete</a></li>
								</ul></li>
						</ul>
					</div>
				</div>
